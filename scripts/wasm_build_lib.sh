...
# Filter out var declarations that re-export wasm symbols we don't want exposed
# at the JS-module top level. The allowlist preserves the wasm-side functions
# that the bindings legitimately need (duckdb_web_*, malloc/free/calloc, stack,
# pthread, emscripten internals).
